const frm = document.querySelector("form") //obtém os elementos da pagina
const resp1 = document.querySelector("#outResp1")
const resp2 = document.querySelector("#outResp2")
const resp3 = document.querySelector("#outResp3")

frm.addEventListener("submit",(e)=>{ //escuta o enetno submit do form
    e.preventDefault()      //evita o envio do formulario do form

    const saque = Number(frm.inSaque.value)  //obtem o valor do saque

    if(saque % 10 !=0){     //se saque não é multilo de 10
