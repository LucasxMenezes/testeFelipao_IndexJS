//cria referencia ao form e aos elementos de respta (pelo seu id)
...
// cria um ouvinte de envento, adcionado quando o botão submit for clicado
...
frm.addEventListener("submit",(e)=> {
    ...
    e.preventDefault()  //evita op envio do form
})